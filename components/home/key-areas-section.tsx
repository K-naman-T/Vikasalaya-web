  ...
  const areas = [
    {
      ...
      image: "/images/mental_health_kerala.webp",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          {areas.map((area, index) => (
            <motion.div
              ...
              className="group bg-secondary rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
            >
